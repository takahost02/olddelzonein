@extends('layouts.app')
@section("breadcrumb")
<li class="breadcrumb-item">{{ link_to_route('service.index', __('fleet.service'))}}</li>
<li class="breadcrumb-item active">@lang('fleet.addService')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.addService')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => 'service.store','method'=>'post','files'=>true,'class' => 'form-reset']) !!}
        <div class="row">
          <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              {!! Form::label('designation', __('fleet.service_detail'), ['class' => 'form-label']) !!}
