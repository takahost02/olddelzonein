...
<li class="breadcrumb-item active">@lang('fleet.editService')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.editService')</h3>
      </div>
      ...
      <div class="card-body">
        ...
        {!! Form::open(['route' => ['service.update',$data->id],'method'=>'PATCH','files'=>true]) !!}
