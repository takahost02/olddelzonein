...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.vowner')</li>
@endsection
@section('content')
<div class="row">
  <div class="col-md-12">
...
<script>
    ...
    @isset($phone_code)
        console.log("Phone Code:", @json($phone_code));
    @endisset

    @isset($vehicles)
        console.log("Vehicles:", @json($vehicles));
    @endisset
</script>
    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('menu.vowner') &nbsp;
          @can('Drivers add') <a href="{{ route('vowner.create') }}" class="btn btn-success"
            title="@lang('fleet.addVowner')"> <i class="fa fa-plus"></i> </a> @endcan
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url'=>'admin/import-vowner','method'=>'POST','files'=>true]) !!}
        <div class="form-group">
          {!! Form::label('excel',__('fleet.importDrivers'),['class'=>"form-label"]) !!}
          {!! Form::file('excel',['class'=>"form-control",'required']) !!}
        </div>
        <div class="form-group">
          <a href="{{ asset('assets/samples/vowner.xlsx') }}">@lang('fleet.downloadSampleExcel')</a>
        </div>
        <div class="form-group">
...
<div id="bulkModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url'=>'admin/delete-vowner','method'=>'POST','id'=>'form_delete']) !!}
