...
@endsection
@section("breadcrumb")
<li class="breadcrumb-item"><a href="{{ route('vowner.index') }}">@lang('menu.vowner')</a></li>
        ...
        <div class="card-header with-border">
          <h3 class="card-title w-100 d-flex justify-content-between align-items-center"> <span>@lang('fleet.driver') @lang('fleet.details')</span>
            <div class=" float-right">
                <a href="{{ route('vowner.edit',$driver->id) }}" class="float-right btn btn-sm btn-warning" title="@lang('fleet.edit_driver')"><i class="fa fa-edit"></i></a>
            </div>
          </h3>
        </div>
