        ...
        <div class="col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="ride_type" value="one_way" class="ride_type">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    oneWayBtn.addEventListener("click", function() {
        ...
        document.querySelector(".ride_type").value = "one_way";
    ...
    returnWayBtn.addEventListener("click", function() {
        ...
        document.querySelector(".ride_type").value = "return_way";
