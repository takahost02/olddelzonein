          ...
          <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar nav-flat flex-column" data-widget="treeview" role="menu"
              ...
              <li class="nav-item">
                ...
                <a href="{{url('admin/book')}}" class="nav-link @if(Request::is('admin/book')) active @endif">

                  <i class="nav-icon fa fa-user"></i>

                  <p>

                    @lang('fleet.manage_bookings')
              ...
              @if((Request::is('admin/drivers*')) || (Request::is('admin/users*')) ||  Request::is('admin/vowner*') || (Request::is('admin/customers*'))
              ...
              @canany(['Users list','Drivers list','Customer list','Vehicle Owner list'])
              ...
              <li class="nav-item has-treeview {{$class}}">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <a href="{{ route('vowner.index')}}"

                      class="nav-link @if(Request::is('admin/vowner*')) active @endif">

                      <i class="fa fa-id-card nav-icon"></i>

                      <p>@lang('menu.vowner')</p>
              ...
              <li class="nav-item has-treeview 
                {{ Request::is('admin/drivers*') ? 'menu-open' : '' }}">
                <a href="#" class="nav-link 
                  {{ Request::is('admin/drivers*') ? 'active' : '' }}">
                  <i class="nav-icon fa fa-users"></i>
                  <p>
                    @lang('menu.users')
                    <i class="right fa fa-angle-left"></i>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    ...
                    <a href="{{ route('material-types.index')}}"
                      ...
                      class="nav-link @if(Request::is('admin/material-types*')) active @endif">

                      <i class="fa fa-th-list nav-icon"></i>

                      <p>@lang('fleet.manage_material_types')</p>
                  ...
                  @endcan
                                          ...
                                          <li class="nav-item">
                                            <a href="{{ route('vehicles.table') }}"
                                               class="nav-link {{ Request::is('admin/table') ? 'active' : '' }}">
                                                <i class="fa fa-truck nav-icon"></i>
                                                <p>@lang('menu.manageVehiclestable')</p>
                                            </a>
                                        </li>
            ...
            @if(Auth::check() && Auth::user()->user_type == "V")
                <li class="nav-item has-treeview 
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/vehicles-track') }}"
                               class="nav-link {{ Request::is('admin/vehicles-track*') ? 'active' : '' }}">
                                <i class="fa fa-location-dot nav-icon"></i>
                                <p>@lang('fleet.vehicles-track')</p>
                            </a>
                        </li>
                ...
                @if(Auth::check() && Auth::user()->user_type == "V")
                  <li class="nav-item has-treeview 
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <!--    <i class="fa fa-money-bill-alt nav-icon"></i>-->
                      <!--    <p>@lang('fleet.transactions')</p>-->
                      <!--  </a>-->
                      <!--</li>-->
                
                      <!--<li class="nav-item">-->
                      <!--  <a href="{{ route('booking-quotation.index') }}"-->
                      <!--    class="nav-link {{ Request::is('admin/booking-quotation*') ? 'active' : '' }}">-->
                      <!--    <i class="fa fa-quote-left nav-icon"></i>-->
                      <!--    <p>@lang('fleet.booking_quotes')</p>-->
                      <!--  </a>-->
                      <!--</li>-->
                
                      <!--<li class="nav-item">-->
                      <!--  <a href="{{ route('bookings.calendar') }}"-->
                      <!--    class="nav-link {{ Request::is('admin/bookings_calendar') ? 'active' : '' }}">-->
                      <!--    <i class="fa fa-calendar nav-icon"></i>-->
                      <!--    <p>@lang('menu.calendar')</p>-->
                      <!--  </a>-->
                      <!--</li>-->
                    </ul>
                  </li>
