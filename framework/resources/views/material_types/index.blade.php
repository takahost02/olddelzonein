@extends('layouts.app')
@section("breadcrumb")
<li class="breadcrumb-item active">@lang('fleet.material_types')</li>
@endsection
@section('extra_css')
<style type="text/css">
  .checkbox, #chk_all{
  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.material_types') &nbsp;
          @can('VehicleType add')<a href="{{ route('material-types.create')}}" class="btn btn-success" title="@lang('fleet.addNew')"><i class="fa fa-plus"></i></a></h3>@endcan
      </div>
        ...
        <table class="table" id="ajax_data_table">
          <thead class="thead-inverse">
            <tr>
              ...
              <th>@lang('fleet.material_types')</th>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        {!! Form::open(['url'=>'admin/delete-material-types','method'=>'POST','id'=>'form_delete']) !!}
    ...
    var table = $('#ajax_data_table').DataTable({
      ...
      buttons: [
        ...
        customize: function ( win ) {
         ...
         serverSide: true,
         ajax: {
          url: "{{ url('admin/material-types-fetch') }}",
          type: 'POST',
          data:{}
         },
         columns: [
