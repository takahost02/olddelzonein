...
Route::namespace ('Backend')->middleware(['throttle', 'auth:backend', 'updatepassporttoken'])->group(function () {
    ...
    Route::post('import-vowner', 'VownerApiController@import_records')->middleware('backendpermission:0');
    ...
    // driver profile API
    Route::post('vowner/yearly-report', 'VownerApiController@yearly_report')->middleware('backendpermission:D');
    Route::post('vowner/monthly-report', 'VownerApiController@monthly_report')->middleware('backendpermission:D');
    Route::get('vowner/report-dropdown', 'VownerApiController@driver_reports_dropdown')->middleware('backendpermission:D');
    Route::get('vowner/home', 'VownerApiController@profile')->middleware('backendpermission:D');
    Route::get('vowner/my-bookings', 'VownerApiController@my_bookings')->middleware('backendpermission:D');
    ...
    Route::post('delete-team-records', 'TeamApiController@bulk_delete')->middleware('backendpermission:S');
        ...
        //Vowner API
    Route::post('upload-member-image/{id}', 'VownerApiController@upload_documents')->middleware('backendpermission:S');

    Route::get('vowner', 'VownerApiController@teams')->middleware('backendpermission:S');
    Route::post('add-vowner', 'VownerApiController@store')->middleware('backendpermission:S');
    Route::post('edit-vowner', 'VownerApiController@update')->middleware('backendpermission:S');
    Route::post('delete-vowner', 'VownerApiController@delete')->middleware('backendpermission:S');
    Route::post('delete-vowner-records', 'VownerApiController@bulk_delete')->middleware('backendpermission:S');

    
    // service API
    Route::post('upload-service-image/{id}', 'ServiceApiController@upload_documents')->middleware('backendpermission:S');

    Route::get('service', 'ServiceApiController@teams')->middleware('backendpermission:S');
    Route::post('add-service', 'ServiceApiController@store')->middleware('backendpermission:S');
    Route::post('edit-service', 'ServiceApiController@update')->middleware('backendpermission:S');
    Route::post('delete-service', 'ServiceApiController@delete')->middleware('backendpermission:S');
    Route::post('delete-service-records', 'ServiceApiController@bulk_delete')->middleware('backendpermission:S');
    ...
    // Vowner API
    Route::post('upload-vowner-documents/{id}', 'VownerApiController@upload_documents')->middleware('backendpermission:0');
    Route::get('vowner', 'VownerApiController@drivers')->middleware('backendpermission:0');
    Route::post('add-vowner', 'VownerApiController@store')->middleware('backendpermission:0');
    Route::post('edit-vowner', 'VownerApiController@update')->middleware('backendpermission:0');
    Route::get('phone-codes', 'VownerApiController@phone_codes');
    Route::get('available-vehicles/{vid}', 'VownerApiController@vehicles')->middleware('backendpermission:0');
    Route::post('change-active-status', 'VownerApiController@enable_disable')->middleware('backendpermission:0');
    Route::post('delete-vowner', 'VownerApiController@delete')->middleware('backendpermission:0');
    Route::post('delete-vowner', 'VownerApiController@bulk_delete')->middleware('backendpermission:0');
    ...
    Route::post('change-active-status', 'VownerApiController@enable_disable')->middleware('backendpermission:0');
    Route::post('delete-vowner', 'VownerApiController@delete')->middleware('backendpermission:0');
    Route::post('delete-vowners', 'VownerApiController@bulk_delete')->middleware('backendpermission:0');
});
