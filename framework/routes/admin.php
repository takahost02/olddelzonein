...
Route::namespace ('Admin')->group(function () {
    ...
    // dd('test');
        ...
        Route::get('/book', 'HomeController@books')->name('drivers.books')->middleware(['lang_check', 'auth']);
        Route::get('{id}/modify', 'HomeController@modify')->name('drivers.modify')->middleware(['lang_check', 'auth']);
        Route::patch('/update/{id}', 'HomeController@updatebooking')->middleware(['lang_check', 'auth']);
        ...
        Route::get('/vowner/verify-vowner/{id}', 'VownerController@verify_vowner');
        Route::post('/vowner/update_verify_vowner', 'VownerController@update_verify_vowner')->name('update_verify_vowner');
       
        Route::post('/check-meta-unique', 'VownerController@checkMetaUnique')->name('check.meta.unique');
        ...
        Route::post('/vowner/check-license', 'VownerController@checkLicenseNumber')->name('vowner.checkLicenseNumber');
        Route::post('/check-license-plate', 'VehiclesController@checkLicensePlate')->name('check.license.plate');
        Route::get('/drivers/{id}/edit', 'DriversController@edit')->name('drivers.edit');
        Route::get('drivers/{driver}/send', 'DriversController@send')->name('drivers.send.form');
        


        
        Route::get('/vehicles-track/{id?}','TrackerController@traccarLocation');
        Route::get('/table','VehiclesController@table')->name('vehicles.table');
        ...
        Route::get('get-vowner-index', 'VownerController@get_vowner_index');
        ...
        Route::get('vehicles/{id}/modify', 'VehiclesController@modify')->name('vehicles.modify');
        
      
        Route::patch('vehicles/change/{vehicle}', 'VehiclesController@change')->name('vehicles.change');
        ...
        Route::resource('vowner', 'VownerController');
        ...
        Route::post('import-vowner', 'VownerController@importVowner');
        ...
        Route::post('delete-service', 'ServiceController@bulk_delete');
        ...
        Route::post('delete-vowner', 'VownerController@bulk_delete');
        ...
        Route::post('delete-material-types', 'MaterialTypeController@bulk_delete');
        ...
        Route::post('/material-types-fetch', 'MaterialTypeController@fetch_data');
        Route::resource('/vehicle-types', 'VehicleTypeController');
        Route::resource('/material-types', 'MaterialTypeController');
        Route::get('get-drivers-by-owner/{ownerId}', 'DriverController@getDriversByOwner');
        Route::get('drivers/{id}/edit', 'DriversController@edit');
        Route::patch('/drivers/{driver}/send', 'DriversController@send')->name('drivers.send');
        ...
        Route::get('single-vowner/{id}', 'VownerController@single_vowner');
        Route::get('vowner-maps/', 'VownerController@vowner_maps');
        Route::get('markers/', 'VownerController@markers');
        Route::get('track-vowner/{id}', 'VownerController@track_vowner');
        ...
        Route::post('vowner-fetch', 'VownerController@fetch_data');
        Route::resource('/drivers', 'DriversController');
        Route::resource('/vowner', 'VownerController');
        Route::resource('/parts', 'PartsController');
        Route::post('/vehicles-fetch', 'VehiclesController@fetch_data');
        Route::post('/table-fetch', 'VehiclesController@fetch_table_data');
        ...
        Route::post('/vehicles-bookings-fetch', 'BookingsController@fetch_data');
        
        Route::post('/driver-bookings-fetch', 'DriversController@fetch_bookings_data');
        Route::post('/vowner-bookings-fetch', 'VownerController@fetch_bookings_data');
        ...
        Route::get("/vowner/enable/{id}", 'VownerController@enable');
        Route::get("/vowner/disable/{id}", 'VownerController@disable');
    ...
    Route::group(['middleware' => ['lang_check', 'auth']], function () {
        ...
        Route::get('/my_bookings_vowner', 'VownerController@my_bookings_vowner')->name('my_bookings_vowner');
...
// vehicle booking
        Route::get('vehicle-booking', 'VehiclesController@vehicle_booking_index')->name('vehicle_booking');
        Route::get('print-vehicle-booking/{id}', 'VehiclesController@print_vehicle_booking');
        Route::post('/vehicles-booking-fetch', 'VehiclesController@fetch_booking_data');
        Route::get('vehicle-booking-create', 'VehiclesController@vehicle_booking_create');
        Route::post('store-vehicle-booking-review', 'VehiclesController@store_vehicle_booking_review');
        Route::get('view-vehicle-booking/{id}', 'VehiclesController@view_vehicle_booking');        
// fuel detail
...
// driver reports
        ...
        Route::get("/vowner-reports/yearly", "VownerController@yearly")->name("dreports.yearly");
        Route::post("/vowner-reports/yearly", "VownerController@yearly_post")->name("dreports.yearly");
        Route::get("/vowner-reports/monthly", "VownerController@monthly")->name("dreports.monthly");
        Route::post("/vowner-reports/monthly", "VownerController@monthly_post")->name("dreports.monthly");
